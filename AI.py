...
def wishMe():
    ...
    if hour>=6 and hour<12:
        speak("Good Morning Arnaud!")

    elif hour>=12 and hour<18:
        speak("Good Afternoon Arnaud!")

    elif hour>=18 and hour<24:
        speak("Good Evening Arnaud!")

    else:
        speak("Good Night Arnaud!")
...
def lightoff():
    driver = webdriver.Chrome('C:/Users/Arnaud/Downloads/chromedriver.exe')
    driver.get("https://Add here.000webhostapp.com/main.html")Add the webhost name
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            speak(f"Arnaud, the time is {strTime}")
